...
public class PlayGame {
    ...
    public static void playOptions() throws IOException, InterruptedException {
        ...
        Main.screen.clear();
        Main.screen.refresh();
        Main.formatter.printMulti(2, Main.formatter.loadArt("ascii-art/main-title.txt"), TextFormatter.PaddingAlignment.CENTER);
    ...
    public static void initializeSave() throws IOException, InterruptedException {
        ...
        Saves.saveSave(SaveHandler.getFile(fileName), "eastern farms", characterName, 0, 0, 0, 0);
