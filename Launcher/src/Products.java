...
public class Products {
    ...
    public static GameClasses.Product shotgun = new GameClasses.Product("[RENTAL] Coolins&Coolinson Lever Action Shotgun", "A ranged weapon that consumes all ammo (max 5) upon use but multiplies the damage dealt by the amount of ammo consumed.", 100, ((entity) -> {
        try {
