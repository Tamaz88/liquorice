...
public class Saves {
    ...
    public static class SaveData {
        ...
        public int getPlantation() {return plantation;}
        ...
        public void setPlantation(int plantation) {this.plantation = plantation;}
    }
    ...
    public static void loadSave(File saveFile) throws IOException, InterruptedException {
        ...
        Globals.plantationSize = save.getPlantation();
        SceneController.loadScene(save.getScene());
    }


    public static void saveSave(File saveFile, String scene, String name, int nemesisPercentage, int money, int progress, int plantation) throws IOException, InterruptedException {
